...
const schema=z.object({
  ...
  STRIPE_SECRET_KEY:optionalText,STRIPE_WEBHOOK_SECRET:optionalText,NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY:optionalText,STRIPE_REFUND_INSTRUCTIONS_EMAIL:optionalEmail,
