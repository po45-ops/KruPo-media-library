 ...
 * as of the last B-1.x check (Assignments=0, Assessments=603):
 *   {
 *     runId: "<a fresh UUID>",
 *     mode: "DRY_RUN",
 *     rowsPlanned: 458,
 ...
 *     afterCounts:  { Assignments: 0, Assessments: 603 },   // unchanged -- proves 0 mutations
 *     rollbackManifest: null
 *   }
...
function RUN_DRY_RUN_PHASE_B() {
  var result = phaseB_writeAssignments(
    ...
    'DRY_RUN',
    { expectedAssignmentsBefore: 0, expectedAssessmentsBefore: 603 }
  );
